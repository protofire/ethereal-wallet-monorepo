...
export const DEFAULT_TESTNET_CHAIN_ID = +(process.env.NEXT_PUBLIC_DEFAULT_TESTNET_CHAIN_ID ?? chains['ethereal-testnet-0'])
export const DEFAULT_MAINNET_CHAIN_ID = +(process.env.NEXT_PUBLIC_DEFAULT_MAINNET_CHAIN_ID ?? chains['ethereal'])
...
export const GATEWAY_URL_STAGING =
  process.env.NEXT_PUBLIC_GATEWAY_URL_STAGING || 'https://gateway.safe.etherealtest.net'
...
export const BRAND_NAME = process.env.NEXT_PUBLIC_BRAND_NAME || 'Ethereal Safe'
