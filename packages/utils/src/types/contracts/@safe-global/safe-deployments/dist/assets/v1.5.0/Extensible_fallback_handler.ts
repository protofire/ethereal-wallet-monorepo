...
export interface Extensible_fallback_handlerInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "addSupportedInterfaceBatch",
  ...
  encodeFunctionData(
    functionFragment: "removeSupportedInterfaceBatch",
    values: [BytesLike, BytesLike[]]
  ): string;
  encodeFunctionData(
...
export interface Extensible_fallback_handler extends BaseContract {
  connect(runner?: ContractRunner | null): Extensible_fallback_handler;
  waitForDeployment(): Promise<this>;

  interface: Extensible_fallback_handlerInterface;
  ...
  addSupportedInterfaceBatch: TypedContractMethod<
  ...
  removeSupportedInterfaceBatch: TypedContractMethod<
    [_interfaceId: BytesLike, selectors: BytesLike[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "addSupportedInterfaceBatch"
  ): TypedContractMethod<
    [_interfaceId: BytesLike, handlerWithSelectors: BytesLike[]],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "removeSupportedInterfaceBatch"
  ): TypedContractMethod<
    [_interfaceId: BytesLike, selectors: BytesLike[]],
    [void],
    "nonpayable"
